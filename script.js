...
//   // 一般費 → 幹事に集約
//   if(!useCommFee){
//     const generalCount = members.filter(m=>m.useGeneralFee).length;
//     const extra = generalCount * 2000;
//     roundedPayments[organizerIndex] += extra;
//   }

//   let sumRounded = roundedPayments.reduce((a,b)=>a+b,0);
//   let totalPaid = useCommFee ? sumRounded + 3000*members.length : sumRounded;
//   let remainder = totalInput - totalPaid;
...
//     totalPaid = useCommFee ? sumRounded + 3000*members.length : sumRounded;
//     remainder = totalInput - totalPaid;
//   }
